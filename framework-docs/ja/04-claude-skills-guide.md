...
2. [Skills の仕組み](#2-skills-の仕組み)
3. [Skills の配置場所](#3-skills-の配置場所)
4. [SKILL.md の構造](#4-skillmd-の構造)
5. [Skills の作成方法](#5-skills-の作成方法)
6. [実践的な Skills 例](#6-実践的な-skills-例)
7. [玄人開発カスタム Skills](#7-玄人開発カスタム-skills)
8. [スラッシュコマンド・サブエージェントとの違い](#8-スラッシュコマンドサブエージェントとの違い)
