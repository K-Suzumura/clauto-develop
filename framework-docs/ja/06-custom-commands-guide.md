...
1. [概要](#1-概要)
2. [仕様フェーズ](#2-仕様フェーズ)
3. [計画・実装フェーズ](#3-計画実装フェーズ)
4. [品質保証フェーズ](#4-品質保証フェーズ)
5. [Git操作](#5-git操作)
6. [統合ワークフロー](#6-統合ワークフロー)
7. [保守・運用](#7-保守運用)
8. [コマンド配置場所](#8-コマンド配置場所)
...
### 6.2 /fixup-from-pr-comments - レビュー対応
...
### 7.2 /session:compact-smart - スマートコンパクト
